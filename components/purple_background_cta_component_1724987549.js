...
<template>
  <section id="cta-section-container" style="min-height: 390px"  class="bg-gradient-to-br from-pink-500 via-purple-600 to-black min-h-screen flex items-center justify-center">
